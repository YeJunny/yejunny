	...
	HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	for (UINT index = 0; index < numModes; ++index)
	{
		if (displayModeList[index].Width == (unsigned int)screenWidth 
			&& displayModeList[index].Height == (unsigned int)screenHeight)
		{
	...
	// Store the dedicated video car memory in megabytes.
	m_videoCardMemory = (int)(adapterDesc.DedicatedVideoMemory / 1024 / 1024);

	// Convert the name of the vidio card to a character array and store it.
	int error;
