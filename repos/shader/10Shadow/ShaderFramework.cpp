...
void RenderScene()
{
	...
	{
		D3DXVECTOR3 vEyePt( gWorldLightPosition.x,
							gWorldLightPosition.y,
							gWorldLightPosition.z );
	...
	{
		D3DXMatrixPerspectiveFovLH( &matLightProjection,
									D3DX_PI / 4.0f,
									1,
									1,
									1000 );
	...
	D3DXMATRIXA16 matViewProjection;
	{
		...
		D3DXVECTOR3 vEyePt( gWorldCameraPosition.x,
							gWorldCameraPosition.y,
	...
	// 그림자맵의 렌더타킷과 깊이 버퍼를 사용한다
	LPDIRECT3DSURFACE9 pShadowSurface = NULL;
	if ( SUCCEEDED( gpShadowRenderTarget->GetSurfaceLevel(
											0,
											&pShadowSurface) ))
	{
