...
float4 ShadowMapping_ApplyShadowTorus_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR0
{   
...
technique ShadowMapping
{
   ...
   {
      VertexShader = compile vs_3_0 ShadowMapping_ApplyShadowTorus_Vertex_Shader_vs_main();
